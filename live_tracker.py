...
# otherwise, grab a reference to the video file
	...
	duration = vs.get(cv2.CAP_PROP_POS_MSEC)
	print(duration)
...
name = f"out{len(out_list) + 1}"
fout = os.path.join("output", name)
# os.system('clear')
print(f"Tracking complete and saved to {fout}")
print(len(points))
output = {
	"points": points,
}
